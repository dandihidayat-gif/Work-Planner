...
export default function ExportReportModal({ projects, tasks, onClose }) {
  ...
  const handleExport = async () => {
    ...
    // footer: TALJER branding + page number + app link
    ...
    for (let i = 1; i <= totalPages; i++) {
      ...
      doc.text('Generated by TALJER — Task List Manager', 40, footerY)

      doc.text(`Halaman ${i} / ${totalPages}`, pageWidth / 2, footerY, { align: 'center' })

      doc.setTextColor(51, 102, 255)
      const urlText = 'work-planner-chi.vercel.app'
      doc.text(urlText, pageWidth - 40 - doc.getTextWidth(urlText), footerY)
    }
